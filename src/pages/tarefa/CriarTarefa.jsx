...
const CriarTarefa = ({handleClose, tarefas, setTarefas}) =>{
  ...
  const [prioridadeTarefa, setPrioridadeTarefa] = useState(''); // Novo estado para a prioridade da tarefa
  ...
  const handlePrioridade = (event) => { // Novo manipulador de evento para a prioridade da tarefa
        ...
        <CardContent sx={{
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={3}>  
              ...
              {/* Campos existentes omitidos para brevidade */}

              {/* Novo campo de seleção para a prioridade da tarefa */}
            <Grid item xs={3}>
            <FormControl fullWidth>
          ...
          {/* Botões e ações existentes omitidos para brevidade */}
